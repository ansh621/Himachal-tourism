...
const ChristianityInHimachal = () => {
    return (
        <div
            ...
            style={{ backgroundImage: "url('/christ-church-shimla2.jpg')" }}
        >
            {/* Light overlay with blur */}
            <div className="absolute inset-0 bg-white bg-opacity-60 backdrop-blur-sm"></div>

            <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                <h1 className="text-center text-5xl font-serif font-semibold text-gray-800 mb-12 select-none">
                    Christianity in Himachal Pradesh
                </h1>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-h-[75vh] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 scroll-smooth">
                    {[
                        {
